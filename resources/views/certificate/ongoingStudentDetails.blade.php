...
@if (!empty($id))
    ...
    @if (\Illuminate\Support\Facades\Auth::id() == $id)
        ...
        <head>
            ...
            <title>Admin | CBBS | Ongoing Student Deatils </title>
                    ...
                    <div class="page-content">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-3">
                                        <button id="markcertified" class="btn btn-primary waves-effect waves-dark">Certified</button>
                                    </div>
                                    <div class="col-md-3">
                                        <button id="markbackregistered" class="btn btn-primary waves-effect waves-dark">Back to Registered</button>
                                    </div>
                                </div> --}}

                                <div class="row">
                                    <div class="col-md-12 d-flex justify-content-between">
                                        <button id="markbackregistered"
                                            class="btn btn-warning waves-effect waves-dark">Back to Registered</button>
                                        <button id="markcertified"
                                            class="btn btn-success waves-effect waves-dark">Certified</button>
                                    </div>
                                </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    function fetchFilteredData() {
                        ...
                        $.ajax({
                            url: "{{ route('ongoingFilterStudents') }}",
                            type: "POST",
                            data: {
                                branch_id: branch_id,
                                course_id: course_id,
                    ...
                    $("#markcertified").click(function() {
                        ...
                        if (selectedStudents.length === 0) {
                            Swal.fire({
                                ...
                                text: 'Please select at least one student to mark as Certified.',
                                confirmButtonColor: '#3085d6'
                            });
                            return;
                        }
                        ...
                        // Send AJAX request
                        $.ajax({
                            url: "{{ route('students.updateStatuscertified') }}",
                            type: "POST",
                            data: {
                            ...
                            success: function(response) {
                                if (response.success) {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Success!',
                                        text: 'Selected students have been marked as Certified.',
                                        confirmButtonColor: '#28a745'
                                    }).then(() => {
                                        window.location.href =
                                            "{{ url('/ongoingStudentDetails') }}";
                                    });
                                } else {
                                    Swal.fire({
                                        icon: 'error',
                    ...
                    // Update student status to "Back to Registered"
                    $("#markbackregistered").click(function() {
                        ...
                        if (selectedStudents.length === 0) {
                            Swal.fire({
                                icon: 'warning',
                                title: 'No Students Selected',
                                text: 'Please select at least one student to move back to Registered status.',
                                confirmButtonColor: '#3085d6'
                            });
                            return;
                        }
                            ...
                            success: function(response) {
                                if (response.success) {
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Success!',
                                        text: 'Selected students have been moved back to Registered status.',
                                        confirmButtonColor: '#28a745'
                                    }).then(() => {
                                        window.location.href =
                                            "{{ url('/ongoingStudentDetails') }}";
